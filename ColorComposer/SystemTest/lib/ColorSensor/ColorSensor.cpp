...
void ColorSensor::_applyScaling()
{
    ...
    //
    //   red   \xd7 1.75  ≈ (raw \xd7 7) >> 2
    //   green \xd7 1.0   (reference, most sensitive channel, used as-is)
    //   blue  \xd7 2.4   ≈ (raw \xd7 157286) >> 16
    //   clear \xd7 1.0   (unscaled ambient light proxy)
    //   IR    \xd7 8     = raw << 3
